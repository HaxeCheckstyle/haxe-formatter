...
- Fixed incorrect function header wrapping ([#439](https://github.com/HaxeCheckstyle/haxe-formatter/issues/439))
- Fixed incorrect wrapping of multiline strings ([#438](https://github.com/HaxeCheckstyle/haxe-formatter/issues/438))

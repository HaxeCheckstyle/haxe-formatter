...
- Added `alignedNestedIncrease` policies to `indentation.conditionalPolicy`, fixes [#519](https://github.com/HaxeCheckstyle/haxe-formatter/issues/519)
...
- Changed default `indentation.conditionalPolicy` to `alignedNestedIncrease`, fixes [#519](https://github.com/HaxeCheckstyle/haxe-formatter/issues/519)
